...
Squirrelly doesn't just limit you to HTML--you can use it with any language, and custom delimeters make it so there aren't parsing errors. It's also tiny (**~2.2 KB gzipped**), has **0 dependencies**, and is **blazing fast**.
